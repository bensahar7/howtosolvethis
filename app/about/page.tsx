...
const personSchema = {
  ...
  description:
    "מתוך סקרנות אמיתית — רציתי להבין איך הסטארטאפים שפותרים את הבעיות הגדולות של תקופתנו עובדים מבפנים, ולשתף את זה בעברית בגובה העיניים. מנחה הפודקאסט 'איך פותרים את זה?', מראיין מייסדים, חוקרים ומשקיעים מהתעשייה.",
  knowsAbout: [
    "Climate Tech",
    "Sustainability",
    "AgriTech",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "בן סהר הוא מנחה הפודקאסט 'איך פותרים את זה?' — הפודקאסט העברי על יזמות סביבתית וחדשנות ישראלית. מתוך סקרנות אמיתית הוא רצה להבין איך הסטארטאפים שפותרים את הבעיות הגדולות של תקופתנו עובדים מבפנים, ולשתף את זה בעברית בגובה העיניים. בן מראיין יזמים, מדענים ומשקיעים שבונים פתרונות לבעיות סביבתיות אמיתיות.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "מה עומד מאחורי הפודקאסט של בן סהר?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "בן סהר הוא מנחה הפודקאסט 'איך פותרים את זה?'. מתוך סקרנות אמיתית הוא רצה להבין איך הסטארטאפים שפותרים את הבעיות הגדולות של תקופתנו עובדים מבפנים — ולשתף את זה בעברית בגובה העיניים. עד היום ראיין עשרות יזמים וחוקרים מתחומי ה-AgriTech, FoodTech, Blue Tech, אנרגיה, חומרים ועוד, ומנגיש את הנושאים מפרספקטיבה עסקית.",
      },
    },
    {
      "@type": "Question",
