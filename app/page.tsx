...
export default function HomePage() {
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-8 md:pb-16 pt-6 md:pt-20">
        <div className="grid grid-cols-12 gap-6">
          {/* Centered Hero Content */}
          <div className="col-span-12 lg:col-span-10 lg:col-start-2">

            {/* H1: Main Title - Bold, High Contrast */}
            <h1 className="hero-title text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-center leading-tight mb-4 md:mb-8 animate-mask-reveal">
              בעיות גדולות,
              <br />
              בגובה העיניים
            </h1>
            ...
            <h2 className="text-base sm:text-xl md:text-2xl lg:text-3xl font-medium text-white/90 text-center leading-relaxed mb-8 md:mb-16 max-w-4xl mx-auto px-2">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-10 lg:col-start-2">
            <div className="glass p-6 md:p-8 lg:p-12 rounded-sm text-right">
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-12 mb-10">
                ...
                <div className="text-center">
                  <div className="flex justify-center mb-2 md:mb-3">
                    <svg className="w-7 h-7 md:w-12 md:h-12 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                    </svg>
                  </div>
                  <AnimatedCounter value={16} prefix="+" className="text-2xl md:text-5xl font-bold text-white mb-1 md:mb-2 block" />
                  <div className="technical-text text-white/60 text-[9px] md:text-sm">פרקים</div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <AnimatedCounter value={2} className="text-2xl md:text-5xl font-bold text-white mb-1 md:mb-2 block" />
                  <div className="technical-text text-white/60 text-[9px] md:text-sm">עונות</div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <AnimatedCounter value={16} prefix="+" className="text-2xl md:text-5xl font-bold text-white mb-1 md:mb-2 block" />
                  <div className="technical-text text-white/60 text-[9px] md:text-sm">חברות</div>
                </div>
              </div>
