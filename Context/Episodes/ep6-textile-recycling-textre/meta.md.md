...
1. **בגדים מורכבים:** הבגדים היום הם "תערובות" (למשל כותנה עם לייקרה), מה שהופך את ההפרדה והמחזור לכמעט בלתי אפשריים בשיטות מסורתיות.
2. **פסולת גלובלית:** תרומות בגדים למדינות כמו גאנה הופכות למעשה למזבלות ענק של טקסטיל שאינו מתכלה.
3. **מיקרו-פלסטיק:** בכל כביסה אנחנו משחררים חלקיקי פלסטיק למערכות המים.



## The Solution
חברת **Textre** פיתחה טכנולוגיה המטפלת בסיבי הבד המעורבים מבלי להפריד אותם. החברה הופכת את פסולת הטקסטיל ל:
- **מצע ללא-אדמה:** ליישומים חקלאיים.
- **תרכובת לתעשיית הפלסטיק:** חומר גלם חדש ושימושי שמחליף פלסטיק בתולי.
הפתרון הופך את "הלכלוך" של תעשיית האופנה למשאב עבור תעשיות אחרות.

## Key Discussion Points
1. **המרוץ לתחתית:** איך מודלים עסקיים של אופנה מהירה פוגעים בסביבה ובזכויות עובדים.
2. **רגולציה ככלי לשינוי:** למה חוקים ואחריות יצרן (EPR) הם הדרך היחידה לגרום לחברות האופנה לקחת אחריות על סוף חיי המוצר.
3. **צרכנות מודעת:** המעבר מקנייה כמותית להערכה מחודשת של הארון האישי והבנת הערך המוסף של קיימות.
