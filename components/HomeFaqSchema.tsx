...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "בן סהר מנחה את הפודקאסט. מתוך סקרנות אמיתית הוא רצה להבין איך הסטארטאפים שפותרים את הבעיות הגדולות של תקופתנו עובדים מבפנים, ולשתף את זה בעברית בגובה העיניים. בן מראיין יזמים, מדענים ומשקיעים שבונים פתרונות לבעיות סביבתיות, ומשלב רקע טכנולוגי עם סקרנות עיתונאית כדי להנגיש את התעשייה לקהל הרחב.",
      },
    },
    {
      "@type": "Question",
